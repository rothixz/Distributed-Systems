...
public class Constants {
    ...
    /**
     * Machine name where the Configurations server is running
     */
    public static final String CONFIG_PC_NAME = "mota-pc";
    
    /**
     * Machine name where the ClientHeistToTheMuseum is running
     */
    public static final String USER_PC_NAME = "mota-pc";
}
